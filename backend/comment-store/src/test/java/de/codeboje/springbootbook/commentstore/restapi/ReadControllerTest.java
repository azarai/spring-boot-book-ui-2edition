...
public class ReadControllerTest {
	...
	public void testGetComments() throws Exception {
		...
		this.mvc.perform(get("/api/comments/" + model.getPageId()))
	...
	public void testGetSpamComments() throws Exception {
		...
		this.mvc.perform(get("/api/comments/" + model.getPageId() + "/spam"))
				.andExpect(status().is(200))
	...
	public void testGetCommentsNotFound() throws Exception {
		this.mvc.perform(get("/api/comments/2")).andExpect(status().is(404));
	}
